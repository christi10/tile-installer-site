...
export default function Footer() {
  return (
    <footer className="bg-primary-light border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed mt-4">
              Professional tile installation services for residential and
              commercial spaces. Precision craftsmanship, lasting results.
            </p>
          </div>

          {/* Services */}
          <div>
            <h3 className="font-heading font-semibold text-white text-sm uppercase tracking-[0.15em] mb-4">
              Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-text-muted text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+441234567890" className="hover:text-accent transition-colors">+44 (0) 123 456 7890</a>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 text-accent shrink-0"
                ...
                <a href="mailto:info@tilecraft.co.uk" className="hover:text-accent transition-colors">info@tilecraft.co.uk</a>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 text-accent shrink-0"
                ...
                <span>London & South East England</span>
              </li>
            </ul>
          </div>
        </div>
